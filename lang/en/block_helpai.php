...
$string['maxpdfsperask'] = 'PDFs attached per question';
$string['maxpdfsperask_desc'] = 'Maximum number of PDF files sent to OpenAI for one question (1–10). Default is 3. All PDF titles in the course are still listed. If the course has this many files or fewer, they are all attached (subject to a 20 MB total).';
...
$string['costheading'] = 'What it costs';
$string['costheading_desc'] = 'The institution pays OpenAI in USD (this plugin does not bill). With GPT-4o, a typical question that attaches 2–3 lecture PDFs is on the order of $0.10–0.25; small PDFs are a few cents; large ones near the 3-file cap can exceed $0.50. A schema is about the same as one one-PDF question. Output is capped (~$0.01). The default daily cap of 20 questions/student is the main spend brake. Prices change: see OpenAI’s pricing page and the plugin README.';
